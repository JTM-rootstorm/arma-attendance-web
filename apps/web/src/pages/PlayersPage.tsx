...
export function PlayersPage({
  ...
  return (
    <div className="view-grid">
      ...
      <CommandPanel title="Player Detail" eyebrow="Attendance signal" wide>
        <DataMessage result={playerDetail} />
        <DataMessage result={playerSummary} />
        {!selectedPlayerUid ? <p className="message">Select a player to inspect attendance history.</p> : null}
        {detail && summary ? (
          <>
            ...
            <TacticalTable label="Player recent operations">
              <thead>
                <tr>
                  <th>Mission</th>
                  <th>Status</th>
